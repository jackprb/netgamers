                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                for(let j=0; j < postsLikes.length; j++){
                                    if(postsLikes[j]["postID"] == posts[i]["postID"]){
                                        post +=`
                                        <svg id="pl${posts[i]['postID']}" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-heart-fill text-dark svg-navbar" viewBox="0 0 16 16" role="img" aria-label="Like button">
                                ...
                                if(!r){
                                    post += `
                                        <svg id="pl${posts[i]['postID']}" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-heart text-dark svg-navbar" viewBox="0 0 16 16" role="img" aria-label="Unlike button">
