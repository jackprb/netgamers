                ...
                function hasLike($dbh){
                    ...
                    if(count($res) == 0){ //no like
                        ...
                        /* non funziona click
                        echo '
                        <svg id="pLikeID" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-heart text-dark svg-lg" viewBox="0 0 16 16" role="img" aria-label="Like button">
                        ...
                        */
                        ...
                        /* non funziona click
                        echo '
                        <svg id="pLikeID" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-heart-fill text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Unlike button">
