                <div class="card-header">
                    <div class="row align-content-center">
                        <div class="col-2">
                            <img class="img-fluid userImgPostHeader rounded-circle" src="<?php echo UPLOAD_USERIMG_DIR . $userImg['path']; ?>" alt="<?php echo $userImg['altText']; ?>" />
                        </div>
                        <div class="col-8">
                        ...
                        <div class="col-2 d-flex justify-content-end">
                            ...
                            <a title="Edit post" class="fs-4 p-2 mx-sm-1" href="modifyPost.php?p=<?php echo $res[0]['ID']?>">
                            ...
                            <a title="DeletePost" class="fs-4 p-2 mx-sm-1" data-bs-toggle="modal" data-bs-target="#modalDeletePost" href="#">
