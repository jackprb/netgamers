                        ...
                        <div class="dropdown nav d-block">
                            <a class="nav-link position-relative p-2" aria-expanded="false" onclick="getNotifications();">
                                <div class="dropdown-toggle">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bell text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Click to open the notifications popup">
                        ...
                        <a class="nav-link p-1" href="#">
                            <div class="form-check form-switch mode-switch ms-auto" data-bs-toggle="mode">
                                ...
                                <label class="form-check-label" for="theme-mode">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-sun text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Light theme">
                                ...
                                <label class="form-check-label" for="theme-mode">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-moon text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Dark theme">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="index.php" title="Home">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-house text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Home">
                            ...
                            <li class="nav-item">
                                <a href="search.php" class="nav-link" title="Search">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-search text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Search">
                            ...
                            <li class="nav-item">
                                <a href="newpost.php" class="nav-link" title="New post">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-plus-square text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Create new post">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link" title="Account" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAccount">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person text-dark svg-md" viewBox="0 0 16 16" role="img" aria-label="Account menu">
