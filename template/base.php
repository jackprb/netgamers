                ...
                <div class="container">
                    ...
                    <nav class="navbar-collapse collapse" id="menu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="newpost.php" class="nav-link <?php isActive("newpost.php"); ?>" title="New post">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link <?php isActive("account.php"); ?>" title="Account" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAccount">
