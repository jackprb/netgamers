                        ...
                        <li class="nav-item mt-3">
                            <div class="dropdown-menu show">
                                ...
                                <a class="dropdown-item" href="account.php">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="<?php echo setSvgColor("account.php"); ?>" class="bi bi-gear text-dark me-2 svg-md" viewBox="0 0 16 16" aria-hidden="true">
                                    ...
                                    </svg><span class="<?php isActive("account.php"); ?>">Account settings</span>
                                </a>
                                <a class="dropdown-item" href="profile.php">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="<?php echo setSvgColor("profile.php"); ?>" class="bi bi-person-check-fill text-dark me-2 svg-md" viewBox="0 0 16 16" aria-hidden="true">
                                        <path fill-rule="evenodd" d="M15.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                                        <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                                    </svg><span class="<?php isActive("profile.php"); ?>">View personal page</span>
                                </a>
                ...
                <div class="container">
                    ...
                    <div class="nav align-items-center order-sm-2">
                        ...
                        <div class="dropdown nav d-block">
                            <a href="#." title="View notifications" class="nav-link position-relative p-2" aria-expanded="false" onclick="getNotifications();">
                                <div class="dropdown-toggle">
                                    ...
                                    <span id="totalNotification" class="badge bg-primary ms-1"></span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-chevron-down text-dark svg-md ms-1" viewBox="0 0 16 16" aria-hidden="true">
                        ...
                        <?php endif; ?>
                        <div title="Change theme" class="nav-link p-1 form-check form-switch mode-switch" data-bs-toggle="mode">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="index.php" title="Home">
                                    ...
                                    </svg><span class="<?php isActive("index.php"); ?> nav-link d-sm-none ms-2">Home</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="search.php" class="nav-link" title="Search">
                                    ...
                                    </svg><span class="<?php isActive("search.php"); ?> nav-link d-sm-none ms-2">Search</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="newpost.php" class="nav-link" title="New post">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="<?php echo setSvgColor("newpost.php"); ?>" class="bi bi-plus-square text-dark svg-navbar" viewBox="0 0 16 16" role="img" aria-label="Create new post">
                                        <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                    </svg><span class="<?php isActive("newpost.php"); ?> nav-link d-sm-none ms-2">New post</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link" title="Account" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAccount">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="<?php echo setSvgColor("account.php", "profile.php"); ?>" class="bi bi-person text-dark svg-navbar" viewBox="0 0 16 16" role="img" aria-label="Account menu">
                                        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
                                    </svg><span class="<?php isActive("account.php", "profile.php"); ?> nav-link d-sm-none ms-2">Account</span>
                                </a>
                            </li>
                        </ul>
                    </nav>
